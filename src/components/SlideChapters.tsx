  ...
  return <section className="slide-container relative py-24">
      ...
      once: true
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground font-body italic">How i found you</p>
          
          <div className="decorative-line" />
        </div>

        <div className="space-y-12">
          {chapters.map((chapter, index) => <motion.article key={chapter.number} initial={{
          opacity: 0,
          y: 40
        }} whileInView={{
          opacity: 1,
          ...
          margin: "-100px"
              ...
              {chapter.bonus && <motion.p initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} transition={{
